...
| 类型           |                   截图                        |            主要参数说明                  |
| ------------- | :-------------------------------------------: | ------------------------------------- |
| drpy          | ![t0](/guide/data/easy-drpy.png)              | 仅支持老版`js0模式`                      |
| tvbox         | ![t1](/guide/data/easy-tvbox.png)             | 仅兼容`部分数据`<br>`不支持加密`           |
| catvod        | ![t1](/guide/data/easy-catvod.png)            | 仅支持nodejs运行环境, `不要打包 `          |

### 2.2. 影视

| 类型           |                   截图                        |            主要参数说明                  |
| ------------- | :-------------------------------------------: | ------------------------------------- |
| T0[xml]       | ![t0](/guide/data/site-t0[xml].png)           | 接口<br>分类                            |
| T1[json]      | ![t1](/guide/data/site-t1[json].png)          | 接口<br>分类                            |
| drpy[js0]     | ![drpy](/guide/data/site-drpy[js0].png)       | 接口                                    |
| T4[hipy]      | ![t4](/guide/data/site-t4[hipy].png)          | 接口                                    |
| T3[js]        | ![t3](/guide/data/site-t3[js].png)            | 接口:任意<br>扩展:接口或规则字符串          |
| catvod[nodejs]| ![catvod](/guide/data/site-catvod[nodejs].png)| 接口                                    |
| csp[XBPQ]     | ![xbpq](/guide/data/site-csp[xbpq].png)       | 接口:`csp[XBPQ]`<br>扩展:接口或规则字符串   |
| csp[XYQ]      | ![xyq](/guide/data/site-csp[xyq].png)         | 接口:`csp[XYQ]`<br>扩展:接口或规则字符串    |
| csp[AppYsV2]  | ![catvod](/guide/data/site-csp[appysv2].png)  | 接口:`csp[AppYsV2]`<br>扩展:接口          |
